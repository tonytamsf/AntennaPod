...
public class PluginMediaResult implements Parcelable {
    ...
    private final List<PluginChapter> chapters = new ArrayList<>();
    ...
    protected PluginMediaResult(Parcel in) {
        ...
        in.readTypedList(chapters, PluginChapter.CREATOR);
    }
    ...
    public List<PluginChapter> getChapters() {
        return chapters;
    }

    public void setChapters(@Nullable List<PluginChapter> newChapters) {
        chapters.clear();
        if (newChapters != null) {
